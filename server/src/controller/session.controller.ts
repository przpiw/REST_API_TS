...
export async function createUserSessionHandler(req:Request,res:Response) {
  ...
  const atcc = config.get("accessTokenCookieConfig");
  // @ts-ignore
  res.cookie("accessToken",accessToken,atcc);
  res.cookie("refreshToken",refreshToken,config.get("refreshTokenCookieConfig"));
